...
function bot_ui_ini() {
	...
	var sure = function() {
			...
			botui.message.add({
				...
				botui.message.add({
					...
					botui.message.add({
						...
						botui.message.add({
							delay: 1500,
							content: "入门java/C/C++,偶尔也搞 HTML/CSS/JavaScript"
						}).then(function() {
							botui.message.add({
								delay: 1500,
								content: "专业方向，啥都学一点，啥也不会"
							}).then(function() {
								botui.message.add({
									delay: 1800,
									content: "喜欢折腾手机和研究一些数码，也喜欢听音乐和看动漫！"
								}).then(function() {
									botui.action.button({
										delay: 1100,
										action: [{
		...
		thirdpart = function() {
			botui.message.add({
				delay: 1e3,
				content: "流星の涙是以前看的一个叫星辰变的漫画的男主法宝名字的一个日文说法。"
			}).then(function() {
				botui.action.button({
					delay: 1500,
					action: [{
		...
		fifthpart = function() {
			botui.message.add({
				delay: 1e3,
				content: "emmmm,bilibili,coolapk,都是流星の涙哦"
			}).then(function() {
				botui.message.add({
					delay: 1600,
